# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 23:43:15 2023
...
class DrydenGustModel:
    def __init__(self, dt, b, h=100, V_a=23.5, intensity=None):
        ...
        :b: (float) wingspan of aircraft
        :h: (float) Altitude of aircraft
        :V_a: (float) Airspeed of aircraft
    ...
    def reset(self, noise=None):
        """
        Reset model.
        :noise: (np.array) Input to filters, should be four sequences of Gaussianly distributed numbers.
        :return:
        """
        self.vel_lin = None
        self.vel_ang = None
    ...
    def simulate(self, length):
        ...
        :length: (int) the number of steps to simulate.
        :return:
        """
